"""Complete schema - alerts and cron_config tables with JSM integration

Revision ID: 0001
Revises: 
Create Date: 2025-06-25 16:00:00.000000
...
def upgrade() -> None:
    # Create alerts table with all fields (basic + acknowledgment + JSM)
    ...
    # Insert default cron jobs for alert synchronization
    op.execute("""
